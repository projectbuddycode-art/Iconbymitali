...
import { Plus, Pencil, Trash2, Copy, Eye, EyeOff, AlertCircle } from "lucide-react";
...
export default function CouponsTab() {
  ...
  // Autosave hook
  const { saveState, clearDraft } = useAutosaveDraft('coupons-form', formData);
  
  // Beforeunload warning
  const hasUnsavedChanges = JSON.stringify(formData) !== JSON.stringify(editingCoupon ? {
    code: editingCoupon.code,
    description: editingCoupon.description || "",
    discount_type: editingCoupon.discount_type || "percentage",
    discount_value: editingCoupon.discount_value,
    minimum_order_value: editingCoupon.minimum_order_value || "",
    usage_limit: editingCoupon.usage_limit || "",
    expiry_date: editingCoupon.expiry_date ? editingCoupon.expiry_date.split('T')[0] : "",
