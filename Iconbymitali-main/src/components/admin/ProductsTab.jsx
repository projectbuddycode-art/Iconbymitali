...
import { Plus, Pencil, Trash2, Upload, X, Image, Video, AlertCircle } from "lucide-react";
...
export default function ProductsTab() {
  ...
  // Autosave hook
  const { saveState, clearDraft, manualSave } = useAutosaveDraft('products-form', formData);
  
  // Beforeunload warning
  const hasUnsavedChanges = JSON.stringify(formData) !== JSON.stringify(editingProduct ? {
    ...
    size_chart_image_url: editingProduct.size_chart_image_url || "",
    stock: editingProduct.stock || 0,
    featured: editingProduct.featured || false,
    show_in_lookbook: editingProduct.show_in_lookbook || false,
