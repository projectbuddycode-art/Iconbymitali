...
const fallbackItems = [
  {
    ...
    collections: { id: 1, name: "Second Skin" }
  },
  {
    title: "Cobalt Dreams",
...
export default function DesignerSpotlight() {
  ...
  // Filter to get featured products (use fallback if none available)
  const collections = allProducts.filter(p => p.featured).slice(0, 6).length > 0 
